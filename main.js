...
그렇게되면 상수가되어 값을 온전히 보존하게됨
const ROUNDNUMBER = 3.14;

let과 거의 동일하며, 다른부분만 살펴본다면
const는 반드시 선언과 동시에 초기화작업을 하여야 문법에러가 발생하지
않습니다
...
let aaa =33; //let으로 변수 선언과 동시에 초기화하여 값을 넣은것
console.log(aaa)
aaa = 44; //기존변수에 값을 덮어쓰는 재할당이 일어난것
console.log(aaa);
